...
`,Te=x.p`
  ...
  width: 70%;
  color: var(--colors-text);
`;const Be=()=>y.createElement(Re,null,y.createElement(Me,{autoPlay:!0,loop:!0},y.createElement("source",{src:"/filmy/assets/poster_video.cbd283e7.mp4",type:"video/mp4"})),y.createElement(De,null,y.createElement(Te,null,"We beleive that movies deserve more",y.createElement("span",{role:"img","aria-label":"heart"},"💜")))),Ue=x.div`
  position: relative;
  display: flex;
  flex-direction: column;
  align-items: center;
...
`,xr=O.div({enter:{y:"0%",staggerChildren:50,transition:{type:"spring",damping:20}},exit:{y:"120%"}}),mr=O.div({enter:{opacity:1},exit:{opacity:0}}),ur=B`
  0% {
